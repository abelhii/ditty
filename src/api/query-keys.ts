/** Central query-key factory so prefetch calls (query-client.ts) and the eventual library
...
export const queryKeys = {
   ...
   *  query-client.ts's dehydrate filter matches to keep search out of the persisted cache. */
